...
# 修改wifi名称
# sed -i "s/OpenWrt/PSG1218/g" ./package/kernel/mac80211/files/lib/wifi/mac80211.sh
...
#theme-rosy
git clone https://github.com/rosywrt/luci-theme-rosy/tree/openwrt-18.06/luci-theme-rosy package/lean/luci-theme-rosy
#passwall
